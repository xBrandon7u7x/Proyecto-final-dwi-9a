    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">GAMES STORE</small></h1>
            </div>
            <p class="lead text-center">
            Bienvenido a GAMES STORE, registrate con un sencillo formulario para poder completar tus pedidos.
            </p>
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/registro.cliente.jpg" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
